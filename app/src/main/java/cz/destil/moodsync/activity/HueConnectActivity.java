...
import cz.destil.moodsync.adapter.AccessPointListAdapter;
import cz.destil.moodsync.light.hue.HueSharedPreferences;
import java.util.List;

/**
 * Created by benediktboss on 19/01/16.
 */
public class HueConnectActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      if (lastIpAddress !=null && !lastIpAddress.equals("")) {
        ...
        if (!phHueSDK.isAccessPointConnected(lastAccessPoint)) {
          AlertWizardDialog.getInstance().showProgressDialog(R.string.connecting, HueConnectActivity.this);
    ...
    private PHSDKListener listener = new PHSDKListener() {
      ...
      public void onAccessPointsFound(List<PHAccessPoint> accessPoint) {
        ...
        AlertWizardDialog.getInstance().closeProgressDialog();
      ...
      public void onAuthenticationRequired(PHAccessPoint accessPoint) {
        ...
        startActivity(new Intent(HueConnectActivity.this, PushlinkActivity.class));
      ...
      public void onError(int code, final String message) {
        ...
        if (code == PHHueError.NO_CONNECTION) {
          ...
          HueConnectActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
              AlertWizardDialog.showErrorDialog(HueConnectActivity.this, message, R.string.btn_ok);
            }
          });
  ...
  public void doBridgeSearch() {
    AlertWizardDialog.getInstance().showProgressDialog(R.string.search_progress, HueConnectActivity.this);
    PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
